...
import { useViewActiveOrgainizationsQuery } from "@/store/apis/orgSuperAdmin/orgSuperAdminApi";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
              View and manage the active organizations in your attendance system
            </p>
          </motion.div>
